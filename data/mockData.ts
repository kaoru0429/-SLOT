...
export const statusDefinitions: { [key: string]: Omit<StatusDefinition, 'text'> } = {
  ...
  'EU_CUSTOMS_CLEARED': { color: 'bg-green-100 text-green-700', icon: '🇪🇺', phase: 'DESTINATION' },
...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    status: 'ARRIVED_ANTWERP',
    statusText: 'Train arrived at Port of Antwerp, awaiting customs',
    serviceType: 'EU_EXPRESS',
